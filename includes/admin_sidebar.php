...
<aside class="admin-sidebar p-3 d-flex flex-column justify-content-between">
  ...
  <div>
    <!-- Brand Logo -->
    <a href="index.php" class="d-flex align-items-center gap-2.5 text-decoration-none px-2 py-2 mb-4 border-bottom border-secondary border-opacity-25 pb-3">
    ...
    <!-- Navigation Menu -->
    <div class="small text-uppercase text-secondary fw-bold px-2 mb-2" style="font-size: 0.7rem; letter-spacing: 0.05em;">
      Main Menu
    </div>
